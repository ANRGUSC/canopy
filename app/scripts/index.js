...
import canopyArtifact from '../../build/contracts/Canopy.json'

// Canopy is our usable abstraction, which we'll use through the code below.
const Canopy = contract(canopyArtifact)
...
const App = {
  start: function () {
    ...
    // Bootstrap the Canopy abstraction for Use.
    Canopy.setProvider(web3.currentProvider)
